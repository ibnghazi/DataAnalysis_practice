...
def print_info(arr):
  ...
  if isinstance(arr, np.ndarray): # 자바의 instance of 와 유사
    print(arr.dtype)
#-------------------------------------------------#
...
def dtype_int():
  ...
  # print_info(arr)
  # => 범위를 벗어난 경우, 실행환경에 따라 overflowError가 발생하거나 wrap-around(순환)할 수 있음
